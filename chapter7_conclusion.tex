...
\item
A simulation environment was implemented to evaluate routing performance under
different network scenarios, including scalability, coherence-time variation,
traffic variation, and multi-seed experiments.
...
This thesis presented a Temporal-State-Aware Routing framework for
fidelity-preserving entanglement distribution in dynamic quantum networks.
By considering temporal evolution of quantum resources and integrating
adaptive routing with regeneration capability, the proposed approach provides
a more reliable alternative to conventional static routing methods.
